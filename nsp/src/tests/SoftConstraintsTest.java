...
public class SoftConstraintsTest {
  ...
  /*
   * For the period of Friday 22:00 to Monday 0:00 a nurse should have either no shifts or at least 2 shifts (‘Complete Weekend’).
   */
  @Test
  ...
  @Test
  public void noShiftsOrAtLeastTwoShiftsOnWeekendsTest4() {
    // 1 zmiana w pt late - koñczy sie o 23 wiec juz zachodzi
    schedule.setSchedule(13, 46);

    constraint.checkSchedule(13, 56, schedule.getAllSchedule());
    assertEquals(1000, constraint.noShiftsOrAtLeastTwoShiftsOnWeekends());
  }
  ...
  /*
   * For employees with availability of 30-48 hours per week, the length of a series of night shifts should be within the range 2-3. It could be
