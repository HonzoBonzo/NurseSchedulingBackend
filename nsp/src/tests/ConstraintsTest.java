...
public class ConstraintsTest {
	...
	public void consecutiveNightShiftsRestTest() {
		...
		// ko�czy prace w �rod� o 7:00 - moze zaczac pracowa� najwczesniej w
		// pi�tek od 1:00
	...
	public void consecutiveNightShiftsRestTest2() {
		...
		// ko�czy prace w czwartek o 7:00 - moze zaczac pracowa� najwczesniej w
		// sobote od 1:00
		// czyli de fakto od porannej zmiany w sobot�
	...
	public void nightShiftRest() {
		...
		//bo zmiana nocna ko�czy si� o 7 rano
		//14 godzin odoczynku pozwoli�o by pracowa� dopiero od godziny 21
		//czyli de facto kolejnej zmiany nocnej o 23
		
		//tak samo ogranicza ju� przecie� minimum 11 godzin odpoczynku w ci�gu 24h
		//bo po zmianie nocnej mo�na pracowa� dopiero od godziny 18 czyli te� de facto
